...
class TransferMoney(models.Model):
    # sender=models.ForeignKey(UserBankAccount, on_delete=models.CASCADE)
    # reciever=models.ForeignKey(UserBankAccount,on_delete=models.CASCADE)
    sender=models.ForeignKey(UserBankAccount,on_delete=models.CASCADE)
    reciever=models.IntegerField()
    amount=models.DecimalField(decimal_places=2,max_digits=12)

class BankAssets(models.Model):
